<?php 
 if(isset($_POST["sendmail"]))
 {
        ...
        $courses=$_REQUEST['courses'];  //echo "</br>";
    
        $to      = 'suwarna@innovativeacademy.in, digital.marketing@innovativeacademy.in';
...
<meta charset="utf-8">
    ...
    <!-- Duplcate link -->
    <link rel="canonical" href="https://www.innovativeacademy.in/courses.php"/>
